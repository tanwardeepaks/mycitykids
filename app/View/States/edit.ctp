<div class="row-fluid">
				<ul class="breadcrumb">
					<?php
						...
						$this->Html->addCrumb('Edit state');
						echo $this->Html->getCrumbs(' / ');
					?>
					
				</ul>
				<h2 class="heading">Edit State</h2>
			</div>
<div class="row-fluid">
		<?php echo $this->Form->create('State',array('class'=>'form-horizontal')); ?>
          <div class="widget widget-padding span12">
            <div class="widget-header">
              <i class="icon-list-alt"></i><h5>Edit State</h5>
            ...
            <div class="widget-body">
              <div class="widget-forms clearfix">
               ...
               <?php /*?>  <?php if($this->Session->read('Auth.User.User.role_id') == 1){ ?>
                  <div class="control-group">
