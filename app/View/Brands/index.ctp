...
<div class="row-fluid">
	  <div class="widget widget-padding span12">
		...
		<form action="<?php echo Configure::read('live_url');?>brands/index" method="get" name="search_method">
		<div class="widget-body" style="padding-bottom:0px;">
		  ...
		  <table cellpadding="10" cellspacing="8" border="0" width="100%">
			...
			<tr>
				...
				<button class="btn" type="button" onclick="window.location.href = '<?php echo Router::url('/');?>brands'">Cancel</button>
				</td>
			</tr>
...
<div class="widget-header">
  ...
  <h5>Brands</h5>
  <div class="widget-buttons">
      <a href="<?php echo Router::url('/').'brands/add'?>" data-title="Add Brand" class="tip" ><i class="icon-plus"></i></a>
  </div>
</div>  
  ...
  <table id="users" class="table table-striped table-bordered dataTable">
	...
	foreach ($brands as $brand):
	 ...
	 ?>
      ...
      <td><span class="label <?php echo ($brand['Brand']['status'])?'label-success':'label-important'?>"><?php echo ($brand['Brand']['status'])?'Active':'Inactive'?></span></td>
      <td><?php echo h(date('Y-m-d',strtotime($brand['Brand']['created']))); ?>&nbsp;</td>
      <td>
          <div class="btn-group">
            ...
            <ul class="dropdown-menu pull-right">
              <li><a href="<?php echo Router::url('/').'brands/edit/'.$brand['Brand']['id'];?>"><i class="icon-edit"></i> Edit</a></li>
            </ul>
          </div>
        </td>
      </tr>
    <?php endforeach;  }else{  ?> 
	<tr>
      <td colspan="7">No Brand available</td></tr>
