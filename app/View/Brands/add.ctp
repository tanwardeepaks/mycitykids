		...
		<?php echo $this->Form->create('Brand',array('class'=>'form-horizontal','enctype'=>'multipart/form-data')); ?>
          <div class="widget widget-padding span12">
            <div class="widget-header">
              <i class="icon-list-alt"></i><h5>Add Brand</h5>
            ...
            <div class="widget-body">
              <div class="widget-forms clearfix">
				  ...
				  <div class="control-group">
                    <label class="control-label">Brands Image</label>
                    <div class="controls">
				  ...
				  <div class="control-group">
                    <label class="control-label">Brands Description</label>
                    <div class="controls">
