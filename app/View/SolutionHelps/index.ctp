<div class="row-fluid">
    <ul class="breadcrumb">
        <?php
            ...
            $this->Html->addCrumb('SolutionHelp');
            echo $this->Html->getCrumbs(' / ');
        ?>
        
    </ul>
    <h2 class="heading">Solution Helps</h2>
</div>
...
<div class="row-fluid">
	  <div class="widget widget-padding span12">
		...
		<form action="<?php echo Configure::read('live_url');?>solutionHelps/index" method="get" name="search_method">
		<div class="widget-body" style="padding-bottom:0px;">
		  ...
		  <table cellpadding="10" cellspacing="8" border="0" width="100%">
			...
			<tr>
				...
				<button class="btn" type="button" onclick="window.location.href = '<?php echo Router::url('/');?>solutionHelps'">Cancel</button>
				</td>
			</tr>
...
<div class="widget-header">
  ...
  <h5>solution Helps</h5>
  <div class="widget-buttons">
      <a href="<?php echo Router::url('/').'solutionHelps/add'?>" data-title="Add Category" class="tip" ><i class="icon-plus"></i></a>
...
<div class="widget-body">
  <table id="users" class="table table-striped table-bordered dataTable">
    ...
    <?php
		...
		foreach ($solutionHelps as $solutionHelp):
		 $index++;
	 ?>
      <tr>
      <td><?php echo  $index + ( ((int)$this->Paginator->counter('{:page}') - 1) * $paginatorParams['limit'] ); ?>&nbsp;</td>
      <td><?php echo h($solutionHelp['SolutionHelp']['name']); ?>&nbsp;</td>
	  <td><?php echo h($solutionHelp['SolutionHelp']['slug']); ?>&nbsp;</td>
	  <td><?php echo h($solutionHelp['SolutionHelp']['type']); ?>&nbsp;</td>
      <td><span class="label <?php echo ($solutionHelp['SolutionHelp']['status'])?'label-success':'label-important'?>"><?php echo ($solutionHelp['SolutionHelp']['status'])?'Active':'Inactive'?></span></td>
      <td><?php echo h(date('Y-m-d',strtotime($solutionHelp['SolutionHelp']['created']))); ?>&nbsp;</td>
       <td><?php echo h(date('Y-m-d',strtotime($solutionHelp['SolutionHelp']['modified']))); ?>&nbsp;</td>
      <td>
          <div class="btn-group">
            ...
            <ul class="dropdown-menu pull-right">
              <li><a href="<?php echo Router::url('/').'solutionHelps/edit/'.$solutionHelp['SolutionHelp']['id'];?>"><i class="icon-edit"></i> Edit</a></li>
              <li><i class="icon-remove"></i><?php echo $this->Form->postLink(__('Delete'), array('admin'=>false,'controller'=>'solutionHelps', 'action' => 'delete', $solutionHelp['SolutionHelp']['id']), null, __('Are you sure you want to "%s" solutionHelp?', $solutionHelp['SolutionHelp']['name'])); ?></li>
            </ul>
          </div>
        </td>
      </tr>
