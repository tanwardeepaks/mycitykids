...
<div class="row-fluid">
				<ul class="breadcrumb">
					<?php
						...
						$this->Html->addCrumb('Edit solution Help');
						echo $this->Html->getCrumbs(' / ');
					?>
					
				</ul>
				<h2 class="heading">Edit solution Help</h2>
			</div>
<div class="row-fluid">
		<?php echo $this->Form->create('SolutionHelp',array('class'=>'form-horizontal','enctype'=>'multipart/form-data')); ?>
          <div class="widget widget-padding span12">
            <div class="widget-header">
              <i class="icon-list-alt"></i><h5>Edit solutionHelps</h5>
              ...
              <div class="widget-forms clearfix">
				  ...
				  <div class="control-group">
                    ...
                    <div class="controls">
				  	...
				  	<?php
				 if($this->request->data['SolutionHelp']['old_image']!='' && file_exists(WWW_ROOT.'uploads'.DS.'solutionhelp'.DS.$this->request->data['SolutionHelp']['old_image'])){?>	
					<div class="control-group">
                    <label class="control-label">&nbsp;</label>
                    <div class="controls">
					<?php echo $this->Html->Image('../uploads/solutionhelp/150x100/'.$this->request->data['SolutionHelp']['old_image']);?>
					</div>
                    <?php } ?>	
				  <div class="control-group">
