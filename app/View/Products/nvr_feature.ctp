...
<div class="row-fluid">
				<ul class="breadcrumb">
					<?php
						...
						$this->Html->addCrumb('NVR Feature');
						echo $this->Html->getCrumbs(' / ');
					?>

				</ul>
				<h2 class="heading">NVR Feature</h2>
			</div>
<div class="row-fluid">
		<?php echo $this->Form->create('NvrFeature',array('class'=>'form-horizontal','enctype'=>'multipart/form-data')); ?>
            ...
            <div class="widget-body">
              <div class="widget-forms clearfix">
                 ...
                 <div class="control-group">
                  		...
                  		<div class="controls">
                  		  <?php
                  		  echo $this->Form->input('hard_disk', array('class' =>'span7 CameraFeatureHardDisk', 'div'=>false, 'label'=>false, 'type' => 'text', 'placeholder' => 'NVR Memory in GB '));
                  		  ?>
                  		</div>
                   </div>
