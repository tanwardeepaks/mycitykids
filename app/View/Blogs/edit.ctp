              ...
              <div class="widget-forms clearfix">
				  ...
				  <div class="control-group">
                    ...
                    <div class="controls">
				  	...
				  	<?php
				 if($this->request->data['Blog']['old_image']!='' && file_exists(WWW_ROOT.'uploads'.DS.'blog'.DS.$this->request->data['Blog']['old_image'])){?>
					<div class="control-group">
                    <label class="control-label">&nbsp;</label>
                    <div class="controls">
					<?php echo $this->Html->Image('../uploads/blog/150x100/'.$this->request->data['Blog']['old_image']);?>
					</div>
					<?php } ?>	
