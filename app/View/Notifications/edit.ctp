...
<div class="row-fluid">
				<ul class="breadcrumb">
					<?php
						...
						$this->Html->addCrumb('Notification',array('controller'=>'notifications','action'=>'index'));
						$this->Html->addCrumb('Edit Notification');
...
<div class="row-fluid">
		<?php echo $this->Form->create('Notification',array('class'=>'form-horizontal','enctype'=>'multipart/form-data')); ?>
              ...
              <div class="widget-forms clearfix">
				  ...
				  <div class="control-group">
                    ...
                    <div class="controls">
				  	...
				  	<?php
				 if($this->request->data['Notification']['old_image']!='' && file_exists(WWW_ROOT.'uploads'.DS.'notification'.DS.$this->request->data['Notification']['old_image'])){?>	
					<div class="control-group">
                    <label class="control-label">&nbsp;</label>
                    <div class="controls">
					<?php echo $this->Html->Image('../uploads/notification/150x100/'.$this->request->data['Notification']['old_image']);?>
					</div>
					<?php } ?>	
