...
<div class="row-fluid">
	  <div class="widget widget-padding span12">
		...
		<form action="<?php echo Configure::read('live_url');?>pages/index" method="get" name="search_method">
		<div class="widget-body" style="padding-bottom:0px;">
		  ...
		  <table cellpadding="10" cellspacing="8" border="0" width="100%">
			...
			<tr>
				...
				<button class="btn" type="button" onclick="window.location.href = '<?php echo Router::url('/');?>pages'">Cancel</button>
				</td>
			</tr>
...
<div class="row-fluid">
          ...
          <div class="widget widget-padding span12">
            <div class="widget-header">
              ...
              <h5>Pages</h5>
              <div class="widget-buttons">
                  <a href="<?php echo Router::url('/').'pages/add'?>" title="Add New Page" class="tifp" ><i class="icon-plus"></i></a>
            ...
            <div class="widget-body">
              <table id="users" class="table table-striped table-bordered dataTable">
				...
				<td><span class="label <?php echo ($page['Page']['status'])?'label-success':'label-important'?>"><?php echo ($page['Page']['status'])?'Active':'Inactive'?></span></td>
				...
				<td>
                      <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-right">
                          <li><a href="<?php echo Router::url('/').'pages/edit/'.$page['Page']['id'];?>"><i class="icon-edit"></i> Edit</a></li>
						  <li><i class="icon-remove"></i><?php echo $this->Form->postLink(__('Delete'), array('admin'=>false,'controller'=>'pages', 'action' => 'delete', $page['Page']['id']), null, __('Are you sure you want to delete "%s" page?', $page['Page']['name'])); ?></li>
                        </ul>
                      </div>
                    </td>
			</tr>
