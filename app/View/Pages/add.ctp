...
<div class="row-fluid">
				<ul class="breadcrumb">
					<?php
						...
						$this->Html->addCrumb('Page',array('controller'=>'pages','action'=>'index'));
						$this->Html->addCrumb('Add Page');
		...
		<?php echo $this->Form->create('Page',array('class'=>'form-horizontal')); ?>
          <div class="widget widget-padding span12">
            <div class="widget-header">
              <i class="icon-list-alt"></i><h5>Add Page</h5>
              <div class="widget-buttons">
              <!--    <a href="#" title="Collapse" data-collapsed="false" class="collapse"><i class="icon-chevron-up"></i></a>-->
              </div>
            </div>
