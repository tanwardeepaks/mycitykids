...
<div class="row-fluid">
	  <div class="widget widget-padding span12">
		...
		<form action="<?php echo Configure::read('live_url');?>categories/index" method="get" name="search_method">
		<div class="widget-body" style="padding-bottom:0px;">
		  ...
		  <table cellpadding="10" cellspacing="8" border="0" width="100%">
			...
			<tr>
				...
				<button class="btn" type="button" onclick="window.location.href = '<?php echo Router::url('/');?>categories'">Cancel</button>
				</td>
			</tr>
...
<div class="widget-header">
  ...
  <h5>Categories</h5>
  <div class="widget-buttons">
      <a href="<?php echo Router::url('/').'categories/add'?>" data-title="Add Category" class="tip" ><i class="icon-plus"></i></a>
  ...
  <table id="users" class="table table-striped table-bordered dataTable">
	...
	foreach ($categories as $category):
	 ...
	 ?>
      ...
      <td><span class="label <?php echo ($category['Category']['status'])?'label-success':'label-important'?>"><?php echo ($category['Category']['status'])?'Active':'Inactive'?></span></td>
      <td><?php echo h(date('Y-m-d',strtotime($category['Category']['created']))); ?>&nbsp;</td>
      <td>
          <div class="btn-group">
            ...
            <ul class="dropdown-menu pull-right">
              <li><a href="<?php echo Router::url('/').'categories/edit/'.$category['Category']['id'];?>"><i class="icon-edit"></i> Edit</a></li>
            </ul>
          </div>
        </td>
      </tr>
    <?php endforeach; }else{  ?> 
	<tr>
      <td colspan="7">No Category available</td></tr>
