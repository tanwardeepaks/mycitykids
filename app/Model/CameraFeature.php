...
public function beforeSave($options = array()) {
	...
	$imageSizeSensor = Configure::read('IMAGESIZESENSOR');
	$hrfPixel = Configure::read('HEFFECTIVEPIXEL');
	$focalLength = Configure::read('FOCALLENGTH');
	
	$chip_width =$this->data[$this->alias]['chip_width'] =  $imageSizeSensor[$this->data[$this->alias]['image_sensor_size']];
	$hrz_eff_pix = $this->data[$this->alias]['hrz_eff_pix'] =  $hrfPixel[$this->data[$this->alias]['hrz_eff_pix']];
	$min_focal_length =$this->data[$this->alias]['min_focal_length'] =  $focalLength[$this->data[$this->alias]['min_focal_length']];
	$max_focal_length = $this->data[$this->alias]['max_focal_length'] =  $focalLength[$this->data[$this->alias]['max_focal_length']];
